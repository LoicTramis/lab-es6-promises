                                ...
                                getInstruction(
                                    ...
                                    (step4) => {
                                        ...
                                        getInstruction(
                                            ...
                                            (error) => console.log("mashedPotatoes error: " + error)
                                        );
                                    },
                                    (error) => console.log(error)
                                );
                        ...
                        obtainInstruction("steak", 6).then((step6) => {
                            ...
                            obtainInstruction("steak", 7).then((step7) => {
                                ...
                                obtainInstruction("steak", 8)
                                    ...
                                    .catch((error) => console.log("steak error: " + error));
                            });
                        });
                    });
                });
...
async function makeBrusselsSprouts() {
    ...
    const steps = await Promise.all([promise0, promise1, promise2, promise3, promise4, promise5, promise6, promise7]);
    const [step0, step1, step2, step3, step4, step5, step6, step7] = steps.values();
